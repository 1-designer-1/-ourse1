...
namespace Сourse1
{
    partial class Rules
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Size = new System.Drawing.Size(672, 60);
            this.label3.TabIndex = 3;
            this.label3.Text = "Что разделить значения используйте символы: «ПРОБЕЛ» / ! # $ % ^ * ( ) { } [ ] &\r" +
    "\n?  . , < > + = @ : ; “ -  так же в конце не должно быть знаков.\r\n\r\n";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Пример заполнения: 2 2 2!2*1";
            // 
            // Options
            // 
